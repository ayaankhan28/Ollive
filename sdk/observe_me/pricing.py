...
PRICING: dict[str, dict[str, dict[str, float]]] = {
    "anthropic": {
        "claude-sonnet-4-6": {"input": 3.0,  "output": 15.0},   # Claude Sonnet 4
        "claude-opus-4-7":   {"input": 5.0,  "output": 25.0},   # Claude Opus 4
        "claude-haiku-4-5":  {"input": 1.0,  "output": 5.0},    # Claude Haiku 4
    ...
    "gemini": {
        ...
        "gemini-2.5-flash": {"input": 0.30,  "output": 2.50},   # preview pricing
