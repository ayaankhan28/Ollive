...
class Trace(Base):
    ...
    # Context IDs — stored without FK constraints to remain decoupled from chat backend
    ...
    # Content previews (truncated at SDK level)
    ...
    def __repr__(self) -> str:
        return f"<Trace trace_id={self.trace_id} provider={self.provider} status={self.status}>"
